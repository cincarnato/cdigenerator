 ...
 */
class FormElement extends \CdiGenerator\Entity\AbstractEntity {
     ...
     * "label":"Form:",
     * "empty_option": "",
     * "target_class":"CdiGenerator\Entity\Form",
     * "property": "name"})
     * @ORM\ManyToOne(targetEntity="CdiGenerator\Entity\Form")
     ...
     * "label":"Type:",
     * "empty_option": "",
     * "target_class":"CdiGenerator\Entity\FormElementType",
     * "property": "name"})
     * @ORM\ManyToOne(targetEntity="CdiGenerator\Entity\FormElementType")
