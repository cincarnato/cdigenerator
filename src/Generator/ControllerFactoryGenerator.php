...
class ControllerFactoryGenerator extends AbstractClassGenerator {
     ...
     * Description
     * 
     * @var \CdiGenerator\Entity\Controller
     */
    private $controller;

    function __construct(\CdiGenerator\Entity\Controller $controller) {
    ...
    function setController(\CdiGenerator\Entity\Controller $controller) {
        $this->controller = $controller;
    }
